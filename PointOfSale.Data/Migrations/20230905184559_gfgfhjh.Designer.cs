...
namespace PointOfSale.Data.Migrations
{
    ...
    [Migration("20230905184559_gfgfhjh")]
    partial class gfgfhjh
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PointOfSale.Model.DetailPurchase", b =>
                {
                    ...
                    b.Property<int?>("IdPurchaseNavigationIdPurchase")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdPurchaseNavigationIdPurchase");
            ...
            modelBuilder.Entity("PointOfSale.Model.Purchase", b =>
                {
                    ...
                    b.Property<int?>("IdPaymentMethodNavigationIdPayment")
                        .HasColumnType("int");

                    b.Property<int?>("IdTypeDocumentPurchase")
                        .HasColumnType("int");

                    b.Property<int?>("IdTypeDocumentPurchaseNavigationIdTypeDocumentPurchase")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdPaymentMethodNavigationIdPayment");

                    b.HasIndex("IdTypeDocumentPurchaseNavigationIdTypeDocumentPurchase");
            ...
            modelBuilder.Entity("PointOfSale.Model.DetailPurchase", b =>
                {
                    b.HasOne("PointOfSale.Model.Purchase", "IdPurchaseNavigation")
                        ...
                        .HasForeignKey("IdPurchaseNavigationIdPurchase");
            ...
            modelBuilder.Entity("PointOfSale.Model.Purchase", b =>
                {
                    ...
                    b.HasOne("PointOfSale.Model.Payment", "IdPaymentMethodNavigation")
                        .WithMany()
                        .HasForeignKey("IdPaymentMethodNavigationIdPayment");

                    b.HasOne("PointOfSale.Model.TypeDocumentPurchase", "IdTypeDocumentPurchaseNavigation")
                        .WithMany("Purchases")
                        .HasForeignKey("IdTypeDocumentPurchaseNavigationIdTypeDocumentPurchase");
                    ...
                    b.Navigation("IdTypeDocumentPurchaseNavigation");
