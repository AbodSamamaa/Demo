...
$(document).ready(function () {
    ...
    tableData = $("#tbData").DataTable({
        responsive: true,
        "ajax": {
            "url": "/Purchases/GetTypeDocumentPurchase",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            {
                "data": "idTypeDocumentPurchase",
                "visible": false,
                "searchable": false
            },
            { "data": "description" },
...
const openModal = (model = BASIC_MODEL) => {
    $("#txtId").val(model.idTypeDocumentPurchase);
...
$("#btnSave").on("click", function () {
    ...
    model["idTypeDocumentPurchase"] = parseInt($("#txtId").val());
    ...
    if (model.idTypeDocumentPurchase == 0) {
        fetch("/Purchases/CreateTypeDocumentPurchase", {
            method: "POST",
            body: formData
        }).then(response => {
        ...
        fetch("/Purchases/UpdateTypeDocumentPurchase", {
            method: "PUT",
            body: formData
        }).then(response => {
            $("#modalData").find("div.modal-content").LoadingOverlay("hide")
    ...
    swal({
        ...
        function (respuesta) {
            ...
            if (respuesta) {
                ...
                fetch(`/Purchases/DeleteTypeDocumentPurchase?idTypeDocumentPurchase=${data.idTypeDocumentPurchase}`, {
                    method: "DELETE"
                }).then(response => {
